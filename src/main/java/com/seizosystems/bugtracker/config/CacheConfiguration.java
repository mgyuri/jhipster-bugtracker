package com.seizosystems.bugtracker.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.seizosystems.bugtracker.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.seizosystems.bugtracker.repository.UserRepository.USERS_BY_EMAIL_CACHE);
